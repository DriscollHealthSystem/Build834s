...
{
    public class STAR_SK_MemberSegments
    {

        public static List<string> BuildMemberSegments(Member_STAR_SK member, string PlanCode)
        {
            ...
            memberSegment.Add(DTP473_or_DTP474(member, PlanCode));
            ...
            memberSegment.AddRange(LX1(member, PlanCode));
            memberSegment.AddRange(LX2(member));
            
            return memberSegment;
        }

        private static string INSSegment(Member_STAR_SK member)
        {
            return "INS*Y*18*" + member.ReasonType + "*" + member.ReasonCode + "*" + member.BenefitStatus + "*" + member.MedicareStatus + "**AC**" + member.SpecialNeeds + "~";
        }

        private static string REF0F(Member_STAR_SK member)
        {
            return "REF*0F*" + member.MedicaidId + "~";
        }

        private static string REF1L(Member_STAR_SK member)
        {
            return "REF*1L*" + member.Employer_Group + "~";
        }

        private static string REF23(Member_STAR_SK member)
        {
            return "REF*23*" + member.MedicaidId + "~";
        }

        private static string REFZZ(Member_STAR_SK member)
        {
            string refzz = "REF*ZZ*";
            ...
            if (!string.IsNullOrEmpty(member.MedicaidRecertification))
            {
                ...
                refzz += member.MedicaidRecertificationEpicId + "|"+ member.MedicaidRecertification + "||" + member.MedicaidRecertification + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_HMO_Migrant_Future))
            {
                refzz += member.HC_HMO_Migrant_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + member.HC_HMO_Migrant_Future + ";";
            }

            if (!string.IsNullOrEmpty(member.HC_FAC_DentalPlan_Future))
            {
                refzz += member.HC_FAC_DentalPlan_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + member.HC_FAC_DentalPlan_Future + ";";
            }

            if (!string.IsNullOrEmpty(member.HC_HMO_PrenatalPCP_Future))
            {
                refzz += member.HC_HMO_PrenatalPCP_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + member.HC_HMO_PrenatalPCP_Future + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_HMO_MedicaidTypeProgram_Future_EpicId))
            {
                refzz += member.HC_HMO_MedicaidTypeProgram_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_HMO_MedicaidCategory_Future_EpicId))
            {
                refzz += member.HC_HMO_MedicaidCategory_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_HMO_MedicaidCoverageCode_Future_EpicId))
            {
                refzz += member.HC_HMO_MedicaidCoverageCode_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_HLT_WaiverTOA_Future_EpicId))
            {
                refzz += member.HC_HLT_WaiverTOA_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_HLT_TiersTOA_Future_EpicId))
            {
                refzz += member.HC_HLT_TiersTOA_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + ";";
            }
            ...
            if (!string.IsNullOrEmpty(member.HC_FAC_PlanCode_Future_EpicId))
            {
                refzz += member.HC_FAC_PlanCode_Future_EpicId + "|" + member.HC_CoveragePeriodBegin_Future + "||" + ";";
            }

            // 2-11-19 | Added a check to see if current coverage dates are empty or null due to some members only having future coverage
            if (!string.IsNullOrEmpty(member.RiskGroup_Current_EpicId) && !string.IsNullOrEmpty(member.HC_CoveragePeriodBegin_Current))
            {
        ...
        private static string DTP473_or_DTP474(Member_STAR_SK member, string PlanCode)
        {
            if(string.Equals(member.HC_FAC_PlanCode_Future, PlanCode))
            {
                if (member.MedicaidBegin_2 != null)
                {
                    return "DTP*473*D8*" + member.MedicaidBegin_2 + "~";
                }
                else
                {
                    return "DTP*473*D8*" + member.MedicaidBegin_1 + "~";
                }
            }
            else
            {
                return "DTP*474*D8*" + member.MedicaidEnd_1 + "~";
            }
        }

        private static string NM1IL(Member_STAR_SK member)
        {
        ...
        private static string PERIP(Member_STAR_SK member)
        {
        ...
        private static string N3Member(Member_STAR_SK member)
        {
            return "N3*" + member.Member_Address_1 + "*" + member.Member_Address_2 + "~";
        }

        private static string N4Member(Member_STAR_SK member)
        {
        ...
        private static string DMGD8(Member_STAR_SK member)
        {
        ...
        private static string LUI(Member_STAR_SK member)
        {
        ...
        private static string N3Mailing(Member_STAR_SK member)
        {
            return "N3*" + member.Member_MailingAddress_1 + "*" + member.Member_MailingAddress_2 + "~";
        }

        private static string N4Mailing(Member_STAR_SK member)
        {
        ...
        private static string NM1S3(Member_STAR_SK member)
        {
        ...
        private static string NM1QD(Member_STAR_SK member)
        {
            /*
            ...
            /*
             *  Requested by Change Control (#528) 5/20/19 - If member is SK, and member's name matches responsible person, and member's age < 18 years old, put Custodial Parent name
             */

            if ((member.Employer_Group.Contains("AAPCA") && member.Member_Name_Equals_Responsible_Party_Name() && member.Member_Age() < 18) || ((member.Employer_Group.Contains("KC") || member.Employer_Group.Contains("KD")) && member.Member_Name_Equals_Responsible_Party_Name() && member.Member_Age() < 18))
            {
        ...
        private static string PERRP(Member_STAR_SK member)
        {
        ...
        private static List<string> HD021_or_HD024(Member_STAR_SK member, string PlanCode)
        {
            ...
            if (string.Equals(member.HC_FAC_PlanCode_Future, PlanCode))
            {
                ...
                section.Add("DTP*348*D8*" + member.HC_CoveragePeriodBegin_Future + "~"); 
            }
            else
            {
        ...
        private static List<string> LX1(Member_STAR_SK member, string PlanCode)
        {
            List<string> section = new List<string>();
        ...
        private static List<string> LX2(Member_STAR_SK member)
        {
            List<string> section = new List<string>();

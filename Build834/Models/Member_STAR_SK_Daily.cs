...
{
    public class Member_STAR_SK_Daily
    {
      ...
      public string HC_HMO_CommunityCareServices_Current { get; set; }
      public string HC_FAC_ProviderCountyCode_Current { get; set; }
      public string HC_HLT_BenefitCode_Current { get; set; }
      public string HC_HLT_PrimaryTaxonomy_Current { get; set; }
      ...
      public string P35_Restorative_Indicator { get; set; }
      public string P35_Restorative_Indicator_EpicId { get; set; }
        ...
        public int Member_Age()
        {
            ...
            try
            {
                DateTime memberDOB = DateTime.Parse(Member_Demographics_BirthDate);

                age = now.Year - memberDOB.Year;
